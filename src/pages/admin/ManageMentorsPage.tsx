...
export default function ManageMentorsPage() {
  ...
  const [editForm, setEditForm] = useState<Partial<AdminMentor>>({});
  ...
  const handleEdit = (mentor: AdminMentor) => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Button onClick={() => navigate("/admin/mentors/create")}>
          + Create Mentor
        </Button>
      </div>
                ...
                editingId === mentor.id ? (
                  <tr key={mentor.id} className="bg-yellow-50">
                    ...
                    <td className="px-4 py-3">
                      <Input
                        type="number"
                        value={editForm.positiveReviews ?? 0}
                        onChange={(e) =>
                          setEditForm({
                            ...editForm,
                            positiveReviews: Number(e.target.value),
                          })
                        }
                        className="h-7 text-xs w-16"
                      />
                    ...
                    <td className="px-4 py-3">
                      <input
                        type="checkbox"
                        checked={editForm.isCertified ?? false}
                        onChange={(e) =>
                          setEditForm({
                            ...editForm,
